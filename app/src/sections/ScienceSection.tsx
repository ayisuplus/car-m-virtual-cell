    ...
    <section id="science" className="py-20 px-4 md:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {/* M1/M2 Polarization */}
          <div className="glass-panel rounded-xl overflow-hidden group hover:border-rose-400/30 transition-all duration-300">
            ...
            <div className="p-5">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-lg font-semibold text-white">M1/M2 Polarization</h3>
              </div>
              ...
              <div className="flex flex-wrap gap-2">
                <span className="px-2 py-0.5 rounded text-[10px] bg-rose-400/10 text-rose-400 border border-rose-400/20">IFN-γ</span>
                <span className="px-2 py-0.5 rounded text-[10px] bg-cyan-400/10 text-cyan-400 border border-cyan-400/20">IL-4</span>
                <span className="px-2 py-0.5 rounded text-[10px] bg-rose-400/10 text-rose-400 border border-rose-400/20">TNF-α</span>
                <span className="px-2 py-0.5 rounded text-[10px] bg-cyan-400/10 text-cyan-400 border border-cyan-400/20">TGF-β</span>
              </div>
            </div>
          </div>

          {/* CAR Structure — Interactive SVG */}
          <div className="glass-panel rounded-xl overflow-hidden group hover:border-emerald-400/30 transition-all duration-300 md:col-span-2">
            ...
            <div className="p-5">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-lg font-semibold text-white">CAR Engineering</h3>
              </div>
              <p className="text-sm text-slate-400 leading-relaxed mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                <span className="px-2 py-0.5 rounded text-[10px] bg-emerald-400/10 text-emerald-400 border border-emerald-400/20">scFv</span>
                <span className="px-2 py-0.5 rounded text-[10px] bg-yellow-400/10 text-yellow-400 border border-yellow-400/20">CD3ζ</span>
                <span className="px-2 py-0.5 rounded text-[10px] bg-emerald-400/10 text-emerald-400 border border-emerald-400/20">FcRγ</span>
                <span className="px-2 py-0.5 rounded text-[10px] bg-purple-400/10 text-purple-400 border border-purple-400/20">HER2</span>
              </div>
            </div>
          </div>

          {/* Phagocytosis */}
          <div className="glass-panel rounded-xl overflow-hidden group hover:border-cyan-400/30 transition-all duration-300">
            <div className="h-48 overflow-hidden bg-slate-900/50 relative">
              <img
            ...
            <div className="p-5">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-lg font-semibold text-white">Phagocytosis Control</h3>
              </div>
              <p className="text-sm text-slate-400 leading-relaxed mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                <span className="px-2 py-0.5 rounded text-[10px] bg-rose-400/10 text-rose-400 border border-rose-400/20">CD47</span>
                <span className="px-2 py-0.5 rounded text-[10px] bg-cyan-400/10 text-cyan-400 border border-cyan-400/20">SIRPα</span>
                <span className="px-2 py-0.5 rounded text-[10px] bg-emerald-400/10 text-emerald-400 border border-emerald-400/20">FcγR</span>
                <span className="px-2 py-0.5 rounded text-[10px] bg-purple-400/10 text-purple-400 border border-purple-400/20">Syk</span>
              </div>
            </div>
          </div>

          {/* AI Virtual Tumor */}
          <div className="glass-panel rounded-xl overflow-hidden group hover:border-yellow-400/30 transition-all duration-300 md:col-span-3">
            <div className="h-48 overflow-hidden bg-slate-900/50 relative flex items-center justify-center">
              <div className="absolute inset-0 bg-gradient-to-br from-yellow-400/10 to-transparent" />
              <Brain className="w-16 h-16 text-yellow-400/80 relative z-10 group-hover:scale-110 transition-transform duration-500" />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0a0f1a] to-transparent opacity-60" />
            </div>
            <div className="p-5">
              <div className="flex items-center gap-2 mb-3">
                <span className="w-2 h-2 rounded-full bg-yellow-400" />
                <h3 className="text-lg font-semibold text-white">AI Virtual Tumor — Next Frontier</h3>
              </div>
              <p className="text-sm text-slate-400 leading-relaxed mb-4">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                <span className="px-2 py-0.5 rounded text-[10px] bg-yellow-400/10 text-yellow-400 border border-yellow-400/20">CellForge</span>
                <span className="px-2 py-0.5 rounded text-[10px] bg-yellow-400/10 text-yellow-400 border border-yellow-400/20">scFoundation</span>
                <span className="px-2 py-0.5 rounded text-[10px] bg-yellow-400/10 text-yellow-400 border border-yellow-400/20">AIVC</span>
                <span className="px-2 py-0.5 rounded text-[10px] bg-yellow-400/10 text-yellow-400 border border-yellow-400/20">Digital Twin</span>
              </div>
              <p className="text-[10px] text-slate-500">Immunity & Inflammation, 2026.06 — Zhang et al.</p>
            </div>
          </div>
        </div>
